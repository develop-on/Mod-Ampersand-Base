...
var templateHead = require('../../templates/head.hbs');
var templateBody = require('../../templates/body.hbs');
...
module.exports = View.extend({
    ...
    render: function () {
        ...
        document.head.appendChild(domify(templateHead()));
        ...
        this.pageSwitcher = new ViewSwitcher(this.queryByHook('page-container'), {
            show: function (newView, oldView) {
                ...
                document.title = result(newView, 'pageTitle') || 'My Amazing App';
